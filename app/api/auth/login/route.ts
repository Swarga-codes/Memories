...
try {
    ...
    const response=NextResponse.json({success:true,message:'Logged in successfully!',email,username:existingUser.username,id:existingUser._id,profilePic:existingUser?.profilePic},{status:200})
