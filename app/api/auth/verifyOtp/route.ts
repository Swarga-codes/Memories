...
export async function PUT(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, message: 'User verified successfully!', email: existingUser.email, username: existingUser.username,id:existingUser._id,profilePic:existingUser?.profilePic }, { status: 200 });
